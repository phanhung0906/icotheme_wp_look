...
<div class="redux-container<?php echo esc_attr($expanded); ?>">
	...
	<form method="post" action="<?php echo esc_attr($action); ?>" data-nonce="<?php echo esc_attr($nonce); ?>" enctype="multipart/form-data" id="redux-form-wrapper">
		<input type="hidden" id="redux-compiler-hook" name="<?php echo esc_attr($this->parent->args['opt_name']); ?>[compiler]"
		       value=""/>
		<input type="hidden" id="currentSection" name="<?php echo esc_attr($this->parent->args['opt_name']); ?>[redux-section]"
		       value=""/>
		<?php if ( ! empty( $this->parent->no_panel ) ) : ?>
			<input type="hidden" name="<?php echo esc_attr($this->parent->args['opt_name']); ?>[redux-no_panel]"
		...
		?>
		<input type="hidden" id="last_tab" name="<?php echo esc_attr($this->parent->args['opt_name']); ?>[last_tab]"
...
<?php if ( isset( $this->parent->args['footer_text'] ) ) : ?>
	<div id="redux-sub-footer"><?php echo esc_attr($this->parent->args['footer_text']); ?></div>
<?php endif; ?>
