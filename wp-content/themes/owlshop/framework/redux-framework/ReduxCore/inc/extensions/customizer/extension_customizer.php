        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->_extension_dir ) ) {
                    $this->_extension_dir = trailingslashit( str_replace( '\\', '/', get_template_directory() . '/framework/redux-framework/ReduxCore/inc/extensions/customizer' ) );
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'owlshop' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'owlshop' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'owlshop' ),
