    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = __( "Support hash could not be generated. Please try again later.", 'owlshop' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            add_management_page(
                __( 'Welcome to Redux Framework', 'owlshop' ), __( 'Redux Framework', 'owlshop' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            add_management_page(
                __( 'Redux Framework Changelog', 'owlshop' ), __( 'Redux Framework Changelog', 'owlshop' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Get Support', 'owlshop' ), __( 'Get Support', 'owlshop' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Redux Extensions', 'owlshop' ), __( 'Redux Extensions', 'owlshop' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            add_management_page(
                __( 'The people that develop Redux Framework', 'owlshop' ), __( 'The people that develop Redux Framework', 'owlshop' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            add_management_page(
                __( 'Redux Framework Status', 'owlshop' ), __( 'Redux Framework Status', 'owlshop' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'owlshop' ), $contributor->login ) )
                );
