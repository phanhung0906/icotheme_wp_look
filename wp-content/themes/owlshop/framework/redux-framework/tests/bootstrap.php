...
if ( ! $_tests_dir ) {
	$_tests_dir = realpath( get_template_directory() . '/framework/redux-framework/tests/../tmp-wp-dev/wordpress-tests' ) . '/';
}
...
function _manually_load_plugin() {
	require get_template_directory() . '/framework/redux-framework/tests/tivwp-dm.php';
}
