...
class TIVWP_DM {
    ...
    public static function action_admin_menu() {
        ...
        add_plugins_page(
                '', __('Activate Development Plugins', 'owlshop'), self::MIN_CAPABILITY, self::MENU_SLUG_ACTIVATE, array(
            __CLASS__,
        ...
        add_plugins_page(
                '', __('Deactivate Development Plugins', 'owlshop'), self::MIN_CAPABILITY, self::MENU_SLUG_DEACTIVATE, array(
            __CLASS__,
    ...
    private static function _die_if_not_authorized() {
        if (!current_user_can(self::MIN_CAPABILITY)) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'owlshop'));
        }
    }
