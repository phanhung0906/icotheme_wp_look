    ...
    if ( ! class_exists( 'ReduxFrameworkPlugin' ) ) {
        ...
        class ReduxFrameworkPlugin {
            ...
            public function includes() {
                // Include ReduxCore
                if ( file_exists( get_template_directory() . '/framework/redux-framework/ReduxCore/framework.php' ) ) {
                ...
                if ( file_exists( get_template_directory() . '/framework/redux-framework/ReduxCore/redux-extensions/config.php' ) ) {
                    require_once( get_template_directory() . '/framework/redux-framework/ReduxCore/redux-extensions/config.php' );
                }
            ...
            private static function single_activate() {
                ...
                $notices[] = __( 'Redux Framework has an embedded demo.', 'owlshop' ) . ' <a href="./plugins.php?ReduxFrameworkPlugin=demo">' . __( 'Click here to activate the sample config file.', 'owlshop' ) . '</a>';
            ...
            public function add_action_links( $links ) {
                ...
                /**
                 * return array_merge(
                 *      array( 'redux_plugin_settings' => '<a href="' . admin_url( 'plugins.php?page=' . 'redux_plugin_settings' ) . '">' . __( 'Settings', 'owlshop' ) . '</a>' ),
                 *      $links
                 * );
                 */
            }
