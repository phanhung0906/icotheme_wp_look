...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<div class="clearfix cart-inner">
			<button type="submit" class="button btn-cart add_to_cart single_add_to_cart_button"> <i class="fa fa-shopping-cart"></i>  <?php echo $product->single_add_to_cart_text(); ?></button>
