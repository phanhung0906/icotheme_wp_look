			...
			<?php foreach ( $downloads as $download ) : ?>
				<li>
					<?php
						...
						if ( is_numeric( $download['owlshop'] ) )
							echo apply_filters( 'woocommerce_available_download_count', '<span class="count">' . sprintf( _n( '%s download remaining', '%s downloads remaining', $download['owlshop'], 'woocommerce' ), $download['owlshop'] ) . '</span> ', $download );
