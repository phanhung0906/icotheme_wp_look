	...
	<td>
		<?php if ( ! empty( $available_methods ) ) : ?>
			...
			<?php if ( 1 === count( $available_methods ) ) :
				...
				<input type="hidden" name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo esc_attr($index); ?>" id="shipping_method_<?php echo $index; ?>" value="<?php echo esc_attr( $method->id ); ?>" class="shipping_method" />
